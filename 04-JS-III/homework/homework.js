...
function mesesDelAño(array) {
  ...
  // Tu código:
  let arraynuevo=[];
  for (let i=0; i<array.length;i++){ if (array[i]=== 'Enero'|| array[i]==='Marzo'|| array[i]==='Noviembre') arraynuevo.push(array[i]);}
  if (arraynuevo.length<3) return 'No se encontraron los meses pedidos'; return arraynuevo;
}
